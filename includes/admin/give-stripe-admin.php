...
function give_stripe_add_settings( $settings ) {
	...
	$stripe_settings = array(
		...
		array(
			...
			'desc' => sprintf( __( 'This option will enable <a href="%s" target="_blank">Stripe\'s modal checkout</a> where the donor will complete the donation rather than the default credit card fields on page.', 'give-stripe' ), 'https://stripe.com/checkout' ),
		...
		array(
			...
			'desc'        => __( 'Enable the ability to accept payments via Alipay, China\'s most popular payment method. Only Stripe users in the United States can accept Alipay for USD payments.', 'give-stripe' ),
		...
		array(
			'name' => __( 'Stripe - ACH Settings', 'give-stripe' ),
			'desc' => '<hr>',
